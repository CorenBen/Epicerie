public class Artichaut extends Article implements Aliment{
	int prix;
	String nom;
...
//////////////////////////////////////////////////////////////////////////////////////////////////   CONSTRUCTEURS
	...
	public Artichaut(int prix, float habitude) {   /// Constructeur de test
		super(prix,"Artichaut",habitude);
		vege = true;
		categorie = 3;	
	}
		
	public Artichaut(int prix) { /// Constructeur principal
		super(prix,"Artichaut");
		vege = true;
		categorie = 3;
	}
