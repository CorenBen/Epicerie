public class Fromage extends Article implements Aliment{
	int prix;
	String nom;
...
//////////////////////////////////////////////////////////////////////////////////////////////////   CONSTRUCTEURS
	...
	public Fromage(int prix, float habitude) {   /// Constructeur de test
		super(prix,"Fromage",habitude);
		vege = true;
		categorie = 2;		
	}
		
	public Fromage(int prix) { /// Constructeur principal
		super(prix,"Fromage");
		vege = true;
		categorie = 2;
	}
