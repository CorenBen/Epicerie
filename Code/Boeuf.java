public class Boeuf extends Article implements Aliment{
	int prix;
	String nom;
...
//////////////////////////////////////////////////////////////////////////////////////////////////   CONSTRUCTEURS
	...
	public Boeuf(int prix, float habitude) {   /// Constructeur de test
		super(prix,"Boeuf",habitude);
		vege = false;
		categorie = 2;	
	}
		
	public Boeuf(int prix) { /// Constructeur principal
		super(prix,"Boeuf");
		vege = false;
		categorie = 2;
	}
