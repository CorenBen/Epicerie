public class Chou extends Article implements Aliment{
	int prix;
	String nom;
...
//////////////////////////////////////////////////////////////////////////////////////////////////   CONSTRUCTEURS
	...
	public Chou(int prix, float habitude) {   /// Constructeur de test
		super(prix,"Chou",habitude);
		vege = true;
		categorie = 2;	
	}
		
	public Chou(int prix) { /// Constructeur principal
		super(prix,"Chou");
		vege = true;
		categorie = 2;
	}
